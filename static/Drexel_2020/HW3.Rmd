...
**4.** Create the following plot. _Hint_: you may first want to make the long format of the data using `pivot_longer()`.

```{r, eval = T, fig.height = 3, fig.align = "center"}
PLC_long <- PLC %>%
  pivot_longer(cols = -"id", names_to = "exercise_mode", values_to = "concentration") 
